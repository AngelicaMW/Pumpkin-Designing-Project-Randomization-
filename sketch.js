...
function preload() {
  ...
  //pumpkin 2
  pumpkin2 = loadImage("./Photos/pumpkin2.png");
...
function draw() {
  ...
  if (face_id == 1) {
    image(face1, 0, 120, 500, 300);
  } else if (face_id == 2) {
    image(face2, 0, 120, 500, 300);
  } else if (face_id == 3) {
    image(face3, 160, 120, 200, 330);
  }
  ...
  // //line(250, 400, 275, 375);
  if (candy_id == 1) {
    image(candy1, 0, 400, 230, 220);
  } else if (candy_id == 2) {
    image(candy2, 0, 400, 230, 220);
  } else if (candy_id == 3) {
    image(candy3, 0, 400, 230, 220);
  }
